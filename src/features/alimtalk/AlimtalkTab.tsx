...
const TEMPLATE_CODES = [
  ...
  'bizp_2026040708573825806856732',
  'bizp_2026040709050112312208609',
  'bizp_2026041510444512312855998',
];
...
const TEMPLATE_PREVIEWS: Record<string, TemplatePreview> = {
  ...
  'bizp_2026040708573825806856732': {
    body: '[수업이 시작된 선생님이 있다면 꼭 알려주세요!]\n\n안녕하세요, #{닉네임} 회원님!\n\n상담을 진행한 선생님 중, 수업을 시작하신 분이 계시다면 아래 버튼을 눌러 꼭 알려주세요.\n\n📌 수업 미등록 시 수업료 미지급·환불 등의 분쟁이 발생할 경우, 김과외의 모든 지원 서비스(분쟁조정 솔루션 · 김과외 법무팀 지원 등) 제공이 어려워요.',
    buttons: ['시작한 수업이 있어요'],
  },
  'bizp_2026040709050112312208609': {
    body: '[정규과외로 이어지셨다면 꼭 알려주세요!]\n\n안녕하세요, #{닉네임} 회원님!\n\n#{선생님닉네임}(#{선생님 학력}) 선생님과 #{수업유형} 후, 정규과외로 이어졌다면, 아래 버튼을 눌러 꼭 알려주세요.\n\n📌 정규과외로 이어졌으나, 김과외에 정규과외로 미등록된 수업은 수업료 미지급·환불 등의 분쟁이 발생할 경우, 김과외의 모든 지원 서비스(분쟁조정 솔루션 · 김과외 법무팀 지원 등) 제공이 어려워요.',
    buttons: ['정규과외로 이어졌어요!'],
  },
  'bizp_2026041510444512312855998': {
    body: '[김과외] 계정 휴면 전환 안내\n\n#{회원명}님, 김과외 서비스를 12개월 이상 이용하지 않으셔서 이용약관 제7조 제5항에 따라 #{전환예정일}에 휴면 계정으로 전환될 예정입니다.\n\n휴면 전환 시 등록하신 정보가 분리 보관되며, 이후 이용 시 별도 해제 절차가 필요합니다.\n\n※ 본 안내는 김과외 이용약관에 따른 계정 상태 변경 안내 메시지입니다.',
    buttons: ['휴면 해제하기'],
  },
  'crbt_mch_prt_wth_sbjt_v1': {
